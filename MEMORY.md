...
### The memory service is named Rivera (api.wirtel.ca,...

The memory service is named Rivera (api.wirtel.ca, repo Mohit1298/rivera) and the CLI is also Rivera (pip install rivera-cli, repo Mohit1298/rivera-cli)

*Confidence: 1.0 | Status: active | Created: 2026-07-09T16:49:22*
